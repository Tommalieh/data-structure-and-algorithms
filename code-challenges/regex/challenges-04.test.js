...
const isCapitalized = (str) => {
  ...
  let capitalizedWords = str.match(validate);
  ...
  if (capitalizedWords != null){
    ...
    // let newVar = /[A-Z][a-zA-Z]*/g;
  // let result = str.match(newVar);
...
const citiesAtoJ = (arr) => {
  ...
  let result = arr[i].replace(' ', '').replace(' ', '').match(validate);
  if(result !== null){
  // console.log(result[0]);
  citiesAtoJArr.push(result[0]);
}
}
// console.log(citiesAtoJArr);
return citiesAtoJArr;
...
const matchMonth = (input) => {
  // Solution code here...
  let validate = /\b(oct).*?\b/gi;
  let result;
  if (typeof(input) === 'string'){
    result = input.toLowerCase().match(validate);
  console.log(result);
  }
  else{
    result = null;
...
const noPunctuation = str => {
  // Solution code here...
  let validate = /\b\w+\s\b/g;
  let result = str.replace('(', '').match(validate);
  // console.log(result);
  return result;
};
...
let hangman = (str) => {
  ...
  let result = str.replace(validate, '_');
  // console.log(result);
  return result;
};
...
const findShells = (str) => {
  // Solution code here...
  let validate = /\w*ells\b/g;
  let result = str.match(validate);
  // console.log(result);
  return result;
};
