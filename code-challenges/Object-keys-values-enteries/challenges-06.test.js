...
const hasChildrenValues = (arr, character) => {
    ...
    for (let i = 0; i < arr.length; i++){
        objectName = Object.values(arr[i])[0];
        charChildren = Object.values(arr[i])[2];
        // console.log(objectName, character);
        if (objectName !== character || charChildren === []) {
            // console.log('false');
            result = false;
        }
        else if (objectName === character && charChildren.length !== 0){
            // console.log('true');
            result = true;
            break;
        }
...
const hasChildrenEntries = (arr, character) => {
    ...
    let charChildren;
    for (let i = 0; i < arr.length; i++){
        charName = Object.entries(arr[i])[0][1];
        charChildren = Object.entries(arr[i])[2][1];
        // console.log(charName, charChildren, character);
        if (charName !== character || charChildren === []) {
            // console.log('false');
            result = false;
            // console.log(result)
        }
        else if (charName === character && charChildren.length !== 0){
            // console.log('true');
            result = true;
            // console.log(result)
            break;
...
const totalCharacters = (arr) => {
    ...
    arr.forEach(values => {
        ...
        // let chars = Object.values(values)[i];
