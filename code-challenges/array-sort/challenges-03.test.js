...
const sortMeetingsByDay = (arr) => {
  // Solution code here...
    ...
    arr.sort(function(a,b) { 
      // console.log(dayList[dayList.indexOf(a.dayOfWeek)]);
      // console.log(dayList[dayList.indexOf(b.dayOfWeek)]);
      return dayList.indexOf(a.dayOfWeek) > dayList.indexOf(b.dayOfWeek);
  });
  // console.log(arr);
  return arr;
};
...
const sortSchedule = (arr) => {
  ...
  arr.sort((a, b) => {
    if (a.start === b.start || a.dayOfWeek === b.dayOfWeek){
        ...
        let aLength = Math.abs(Number(a.start) - Number(a.end));
        let bLength = Math.abs(Number(b.start) - Number(b.start));
