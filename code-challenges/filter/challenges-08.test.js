...
const oddValues = (arr) => {
    // Solution code here...
    let odds = arr.filter(num => { return num % 2 });
    return odds;
};
...
const filterStringsWithVowels = (arr) => {
    // Solution code here...
    let validate = /\w*[aeiuo].*?\b/gi
    let withVowels = arr.filter(string => {
        return string.match(validate);
    })
...
const notInFirstArray = (forbiddenValues, arr) => {
    // Solution code here...
    let notInFrst;
    notInFrst = arr.filter(value => { return !(forbiddenValues.includes(value)) })
    return notInFrst;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
    // Solution code here...
    let higherStat = arr.filter(data => {
        return data.baseStat > minBaseStat;
    })
    return higherStat;
};
...
const getStatName = (arr, minBaseStat) => {
    ...
    let statName = higherStat.map(obj => {
...
const getCharactersWithoutChildren = (arr) => {
    // Solution code here...
    let charWthChildrn = arr.filter(char => {
        return !char.children;
    })
    // console.log(charWthChildrn)
    return charWthChildrn;
};
...
const evenOddNumericValues = (arr) => {
    // Solution code here...
    let evenOddNums = arr.filter(num => {
        return typeof(num) === 'number'; 
    })
    // console.log(evenOddNums)
    let evenOddStrng = evenOddNums.map(num => {
        if (num % 2 === 0){
            return 'even'
        }
        else{
